...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? pinError, bool isLoading, String? token});
}
...
class _$SplashStateImpl implements _SplashState {
  _$SplashStateImpl({this.pinError, this.isLoading = false, this.token});
  ...
  @override
  String toString() {
    return 'SplashState(pinError: $pinError, isLoading: $isLoading, token: $token)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, pinError, isLoading, token);
...
abstract class _SplashState implements SplashState {
  factory _SplashState(
      {final String? pinError,
      final bool isLoading,
      final String? token}) = _$SplashStateImpl;
